namespace Terrasoft.Configuration
{
	...
	public class UsrYachtEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("1350df82-6f4f-4a8a-9d2e-756974189ec5");
			Name = "UsrYachtEvents";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("715b0fcc-80fa-49a6-bd9c-e7bd918ce9a0");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("820e3ca8-7a6e-e438-dad3-6c379f52ee9e"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("715b0fcc-80fa-49a6-bd9c-e7bd918ce9a0"),
				CreatedInSchemaUId = new Guid("1350df82-6f4f-4a8a-9d2e-756974189ec5"),
				ModifiedInSchemaUId = new Guid("1350df82-6f4f-4a8a-9d2e-756974189ec5")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("1350df82-6f4f-4a8a-9d2e-756974189ec5"));
		}
