namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAvgTicketPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAvgTicketPriceMethodsWrapper : ProcessModel
	{

		public UsrCalculateAvgTicketPriceMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var passengersCountColumn = esq.AddColumn("UsrPassengersCount");  // SELECT UsrPassengersCount as UsrPassengerCount, UsrPrice as UsrPrice FROM UsrYacht WHERE ...
